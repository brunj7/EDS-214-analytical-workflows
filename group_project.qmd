...
#### Log your resources on this [Google Sheet](https://docs.google.com/spreadsheets/d/1cVoUFvSUdn04gzBSPrvmr2ZfkbnlBOG1iCSwill2NA0/edit#gid=0)
...
Write a quarto document that:
    - reads the data in (from a local cpy on Taylor)
...
Go wild!! Ask your own scientific question using the stream chemistry data but also any other external source of data (like [historical hurricane tracks from NOAA](https://www.nhc.noaa.gov/data/)). **The focus in this part of the project is on the process of how you will be answering the question (planning, orkflow, code, data, ....), not on the results per se**
