---
title: "GitHub branching and more only using their website"
---
...
- Create a repository following these [instructions](https://docs.github.com/en/github/getting-started-with-github/create-a-repo) steps 1-6
