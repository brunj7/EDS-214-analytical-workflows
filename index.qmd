...
| 3:10pm - 4:00pm   | *Day Recap +  Q&A  (50 min)*                              |
...
|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|
| Monday morning       |  [Reproducible workflows](https://docs.google.com/presentation/d/e/2PACX-1vRO81O7IJeTHihyMu6yXTsHhWozBbTWWVHy9YJ2ytilrOBji24dzhDTMilQc0hna9prfXLlsLnafa1B/pub?start=false&loop=false&delayms=60000&slide=id.p) | [Planning things: from flow charts to pseudocode](day1-pseudocode.html)|
 Monday afternoon      |  [Coding together](day1-coding_together.html)                 | [Collaborating with GitHub](day_1.html#collaborating-through-forking); [Github collaboration Hands-on](https://github.com/brunj7/eds214-handson-ghcollab); [Bonus: Github conflicts](day1-git-collaboration-conflicts.html)  |
| Tuesday morning      |  [Working on a remote server](day2-remote_server.html)                                    |	[the command line](day3-remote_server.html#command-line) | 
