...
![CERN computing center](img/cern-server-small.jpg){width="120%"}
...
- `Shell`: It is the program that runs the command line. There are many different shells, the most common being `bash` (Bourne Again SHell) that is installed by default in many Linux distributions
