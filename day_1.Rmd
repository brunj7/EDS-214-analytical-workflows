...
[Materials](pseudocode.html)

![Cherubini et al., 2007](img/whiteborad_drawings.png)

### Hands-on

[Investigating the impacts of Hurricane on stream chemistry in Puerto Rico](hands-on_drawings.html)
...
[git and GitHub quick recap](git_github_recap.html)
...
- Work together on Team member 2's computer to modify the `say_aloah()` function to 

- Once done, create a pull request to integrate the new changes tagging team member 1 as reviewer

- Team member 1, review the code, comment as neede on the pull request, and merge changes
...
What about Rmarkdown in all of this? Well the RMarkdown syntax, or more precisely the `knitr` package, add extra R oriented features which allows the translate of R code, figures and more  into a Markdown document to produce dynamic and reproducible documents.
